        ...
        <div class="top-box">
            <div class="sub-nav">
                <div class="col">
                    <ul>
                        <li>
                            <a href="{{ URL::to('/about') }}">{{ __('common.about') }}</a>
                        </li>
                        <li>
                            <a href="">{{ __('common.contacts') }}</a>
                        </li>
                        <li>
                            <a href="">{{ __('common.terms_and_rules') }}</a>
                        </li>
                        <li>
                            <a href="">{{ __('common.responsible_gambling') }}</a>
                        </li>
                    </ul>
                </div>
                <div class="col">
                    <ul>
                        <li>
                            <a href="">{{ __('common.betting_rules') }}</a>
                        </li>
                        <li>
