{{--@section('main-menu')--}}
<div class="main-menu d-flex d-md-none mobile-menu">
    <div class="container">

        <nav class="navbar navbar-expand-lg navbar-light justify-content-left">
            <a class="p-2 py-3 h4 text-dark text-center" href="#" data-toggle="collapse" data-target="#search-games-mobile" aria-expanded="true" aria-controls="search-games">
                <img class="d-block mx-auto" src="{{ asset('/img/layout2.0/icons/search.png') }}" alt="">
                Search
            </a>
            <a class="p-2 py-3 h4 text-dark text-center game-type" href="{{ URL::to('/games/popular') }}" data-games-type="popular">
                <img class="d-block mx-auto" src="{{ asset('/img/layout2.0/icons/popular.png') }}" alt="">
                Popular Games
            </a>
            <a class="p-2 py-3 h4 text-dark text-center game-type" href="{{ URL::to('/games/casino') }}" data-games-type="casino">
                <img class="d-block mx-auto" src="{{ asset('/img/layout2.0/icons/casino-games.png') }}" alt="">
                Casino Games
            </a>
            <a class="p-2 py-3 h4 text-dark text-center" href="#" data-toggle="modal" data-target=".available-soon-popup">
                <img class="d-block mx-auto" src="{{ asset('/img/layout2.0/icons/sport.png') }}" alt="">
                Sport
            </a>
            <a class="p-2 py-3 h4 text-dark text-center" href="{{ URL::to('/games/table') }}">
            ...
            <a class="p-2 py-3 h4 text-dark text-center" href="{{ URL::to('/games/all') }}" data-games-type="all">
                <img class="d-block mx-auto" src="{{ asset('/img/layout2.0/icons/all-games.png') }}" alt="">
                All Games
            </a>

            <a class="p-2 py-3 h4 text-dark text-center" href="#" data-toggle="collapse" data-target="#filters-block-mobile" aria-expanded="false" aria-controls="filters-block">
        ...
        <div class="filters-wrapper">
            <div class="container">
                ...
                <div class="collapse" id="filters-block-mobile">
        ...
        <div class="search-block-wrapper">
            <div class="container">
                <div class="collapse" id="search-games-mobile">
