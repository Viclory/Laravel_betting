            ...
            <div class="content-box">
                <div class="sub-box">
                    <ul class="choose-list">
                        ...
                        <li>
                            <a href="#" data-text="de">Deutsch</a>
                        </li>
                        <li>
                            <a href="#" data-text="en">English</a>
                        </li>
                        <li>
                            <a href="#" data-text="it">Italiano</a>
                        </li>
                        <li class="rtl">
                            <a href="#" data-text="العربية">العربية</a>
                        </li>
                        <li>
                            <a href="#" data-text="fr">Français</a>
                        </li>
                        <li>
                            <a href="#" data-text="se">Svenska</a>
                        </li>
                        <li>
                            <a href="#" data-text="es">Español</a>
                        </li>
                        <li>
                            <a href="#" data-text="po">Portugues</a>
                        </li>
                        <li>
                            <a href="#" data-text="中國">中國</a>
                        </li>
                        <li>
                            <a href="#" data-text="日本語">日本語</a>
                        </li>
                    </ul>
                </div>
            </div>
